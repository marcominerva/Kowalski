    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddBot<LuisBot>(options =>
            {
                ...
                var logger = _loggerFactory.CreateLogger<LuisBot>();
            ...
            // Add Assistant configuration and services.
            services.Configure<AppSettings>(Configuration.GetSection("AppSettings"));
            services.AddScoped<IDbContext>((opt) => new DbContext(Configuration.GetConnectionString("SqlConnection")));
